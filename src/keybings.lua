...
local cyclefocus = require("src.cyclefocus")
...
globalKeys = gears.table.join(
    ...
    awful.key({ modkey }, "Tab", function(c) cyclefocus.cycle({ modifier="Super_L", }) end, { description = "next window on history", group = "client"}),
    awful.key({ modkey, "Shift" }, "Tab", function(c) cyclefocus.cycle({ modifier="Super_L" }) end, { description = "previous window on history", group = "client"}),
    ...
    awful.key({ modkey }, "d", function () awful.spawn.with_shell("rofi -show drun -modi drun,window -theme-str 'prompt,textbox-prompt-sep { enabled: false; }'") end, { description = "run rofi", group = "launcher" }),
    awful.key({ modkey }, "w", function () awful.spawn.with_shell("rofi -show window -modi drun,window -theme-str 'prompt,textbox-prompt-sep { enabled: false; }'") end, { description = "run rofi window", group = "launcher" }),
